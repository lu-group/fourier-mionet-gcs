...
class Model:
    ...
    def _test(self):
        ...
        for i in range(int(500/batch_size)):
            for j in range(int(self.training_time_size/timestep_batch_size)):
                y_pred_test_timestepbatch, loss_test_batch = self._outputs_losses(
                    ...
                    self.train_state.y_test.reshape(500,self.training_time_size,96,200)[i*batch_size:(i+1)*batch_size,:][:,j*timestep_batch_size:(j+1)*timestep_batch_size,:].reshape(batch_size,-1),
                    self.train_state.test_aux_vars,
        ...
        self.train_state.y_pred_test = self.train_state.y_pred_test.reshape(500,-1)
