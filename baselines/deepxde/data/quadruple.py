...
class QuadrupleCartesianProd(Data):
    ...
    def __init__(self, X_train, y_train, X_test, y_test):
        ...
        self.train_timestep_sampler = BatchSampler(24, shuffle=True)
    ...
    def train_next_batch(self, batch_size=None,timestep_batch_size=None,training_time_size=None):
        ...
        return (
            ...
            self.train_x[2].reshape(training_time_size, 96*200, 3)[indices_timestep,:].reshape(timestep_batch_size*96*200, 3),
        ), self.train_y.reshape(size,training_time_size, 96*200)[indices,:][:,indices_timestep].reshape(batch_size,timestep_batch_size*96*200),indices
