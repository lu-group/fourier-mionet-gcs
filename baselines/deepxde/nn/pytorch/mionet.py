...
class MIONetCartesianProd(NN):
    ...
    def forward(self, inputs):
        ...
        y_func2 = y_func2.reshape(y_func2.shape[0],y_func2.shape[1],1,1)
        ...
        if self.output_merger is None:
            ...
            x_size = y.shape[3]
            y_size = y.shape[4]
            y = y.reshape(batch_size*timestep_size,channal_num,x_size,y_size)
            y = self.output_merger(y)
            y = y.reshape(batch_size,timestep_size*96*200)
        # Add bias
        #y = y + self.b
