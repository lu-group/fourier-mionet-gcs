...
checker = dde.callbacks.ModelCheckpoint("train_MIONet_FNN_SG/MIONet_FNN_SG",save_better_only=False,period=2250*2,monitor="test loss")
start = time.time()
